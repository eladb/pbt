...
module.exports = function() {
   ...
   * @param {function} callback
   */
  api.fql = function (query, callback) {
   ...
   */
  api.getOauthUrl = function (params, opts) {
  ...
  api.authorize = function (params, callback) {
    var self = this;
